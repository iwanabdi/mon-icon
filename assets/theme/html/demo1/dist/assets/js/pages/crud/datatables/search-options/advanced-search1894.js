                    ...
                    ajax:
                    {
                        ...
                        initComplete:function(){
                            this.api().columns().every((function(){
                                var t=this;
                                switch(t.title())
                                {case"Country":t.data().unique().sort().each((function(t,a)
                                {
                                    ...
                                    {
                                        $('.datatable-input[data-col-index="6"]').append('<option value="'+t+'">'+a[t].title+"</option>")
                                    }));
                                    break;
                                    case"Type":a={
                                        ...
                                        t.data().unique().sort().each((function(t,e){
                                            $('.datatable-input[data-col-index="7"]').append('<option value="'+t+'">'+a[t].title+"</option>")
                                        }))}}))},
                                        columnDefs:[{
                                            targets:-1,title:"Actions",
                                            orderable:!1,render:function(t,a,e,l){
