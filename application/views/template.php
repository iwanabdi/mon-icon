					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								<span class="text-muted font-weight-bold mr-1">2022</span>
				...
				<div class="d-flex align-items-center mt-5">
					<div class="d-flex flex-column">
						...
						<div class="text-muted mt-1">
							<?php if($this->session->userdata('status') ==1){
									if($this->session->userdata('jabatan') ==1){
										echo "Supervisor";
									}else if($this->session->userdata('jabatan') == 2) {echo "Engineer";} 
									else if($this->session->userdata('jabatan') == 3) {echo "QC";} 
									else if($this->session->userdata('jabatan') == 4) {echo "Admin";} 
									else if($this->session->userdata('jabatan') == 5) {echo "Gudang";} 
									else{echo "Developer";}
								}
								?>
						</div>
						<div class="navi mt-2">
							...
							<a href="<?=site_url('Auth/logout')?>" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">
								Sign Out
							</a>
						</div>
					</div>
