    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom">
				...
				<div class="card-body">
					<!--begin::Form-->
					<form action="<?= site_url('Master_team/edit_teamlap')?>" method="POST">
						<div class="form-group">
							...
							<input type="hidden" class="form-control" name="id" id="id" required value="<?=$teamlap->teamlap_id?>">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nama" value="<?=$teamlap->nama_team?>" required/>
						</div>
						<div class="form-group">
							<label>Pekerja <span class="text-danger">*</span></label>
							<textarea class="form-control" name="pekerja" rows="2" required><?=$teamlap->nama_pekerja?></textarea>
						</div>
